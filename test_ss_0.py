...
for i, ff1_vector in enumerate(ff1_features):
    for j, ff2_vector in enumerate(ff2_features):
        similarity = np.dot(ff1_vector, ff2_vector) / (np.linalg.norm(ff1_vector) * np.linalg.norm(ff2_vector))
